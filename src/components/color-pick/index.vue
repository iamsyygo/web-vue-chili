<template>
  <a-popover trigger="click" @openChange="handlePopover" ref="popoverRef">
    <template #content>
      <div class="color-pick-canvas">
        ...
        <div class="color-pick-bottom">
          <a-input :value="modelColorValue" />
          <a-button @click="modelColorValue = ''" size="middle" style="margin-left: 5px">
            清 空
          </a-button>
          <!-- <a-button type="primary" @click="confirm" size="middle" style="margin-left: 5px">
            确 定
          </a-button> -->
        </div>
      </div>
    </template>
    <div class="color-pick-block--warpper">
      <div class="color-pick-block" :style="{ backgroundColor: modelColorValue }"></div>
    </div>
  </a-popover>
</template>
